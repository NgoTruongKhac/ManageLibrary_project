...
export default function TicketBorrow() {
  ...
  const fetchTickets = async () => {
    try {
      const res = await ticketApi.getAllTicketByStatus("đang mượn", page);
  ...
  const handleReturned = (ticketId) => {
    Swal.fire({
      text: "Xác nhận phiếu đã trả?",
      icon: "question",
      ...
      if (result.isConfirmed) {
        ...
        try {
          const res = await ticketApi.setTicketStatus(ticketId, "đã trả");
          if (res) {
            fetchTickets();
                  ...
                  <tr key={ticket._id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => handleReturned(ticket._id)}
                      >
                        xác nhận trả
                      </button>
                    </td>
