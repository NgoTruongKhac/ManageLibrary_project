...
export default function TicketApprovaled() {
  ...
  const fetchTickets = async () => {
    try {
      const res = await ticketApi.getAllTicketByStatus("đã duyệt", page);
  ...
  const handleApprovaled = (ticketId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        try {
          const res = await ticketApi.setTicketStatus(ticketId, "đang mượn");
          if (res) {
            fetchTickets();
  ...
  const handleCanelTicket = (ticketId) => {
    ...
    Swal.fire({
      text: "Bạn có muốn huỷ phiếu này?",
      icon: "question",
      showCancelButton: true,
                  ...
                  <tr key={ticket._id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => handleApprovaled(ticket._id)}
                      >
                        Cho mượn
                      </button>
                    </td>
