...
export default function TicketApproval() {
  ...
  const fetchTickets = async () => {
    try {
      const res = await ticketApi.getTicketByStatus("chờ duyệt");
      setTickets(res.data);
    } catch (error) {
  ...
  const handleCanelTicket = async (ticketId) => {
    try {
  ...
  return (
    <div className="p-4">
      <h2 className="text-xl font-semibold mb-4">Danh sách phiếu chờ duyệt</h2>
