...
export default function ModalEditUser({ userId, onUserUpdated }) {
  ...
  useEffect(() => {
    const fectUser = async () => {
      try {
        const res = await apiUser.getUser(userId);
        setUser(res.data);
      } catch (error) {
        console.error(error);
      }
  ...
  const handleUpdateUser = async () => {
    try {
      ...
      const res = await apiUser.updateUserAdmin(userId, formData);
      if (res) {
        setUsername("");
        setEmail("");
        setPassword("");
